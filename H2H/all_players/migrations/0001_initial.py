# Generated by Django 5.1.4 on 2025-04-24 05:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headshot', models.CharField(default='0', max_length=100)),
                ('yearly_proj', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
            ],
        ),
        migrations.CreateModel(
            name='Def_Stats',
            fields=[
                ...
                ('location', models.CharField(default='0', max_length=20)),
                ('team', models.CharField(default='0', max_length=20)),
                ('week', models.IntegerField(default=0)),
                ...
                ('proj_fantasy', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('total_fantasy_points', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
