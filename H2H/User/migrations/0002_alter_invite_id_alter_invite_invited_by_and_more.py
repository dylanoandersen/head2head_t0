# Generated by Django 5.1.4 on 2025-04-07 15:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='invite',
            name='invited_by',
            field=models.ForeignKey(db_column='invited_by_id', on_delete=django.db.models.deletion.CASCADE, related_name='sent_invites', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='invite',
            name='invited_user',
            field=models.ForeignKey(db_column='invited_user_id', on_delete=django.db.models.deletion.CASCADE, related_name='received_invites', to=settings.AUTH_USER_MODEL),
        ),
